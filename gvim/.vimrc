...
function AddHeader() 
       ...
       call append(11, "//")
       call append(12, "// -FHDR----------------------------------------------------------------------------")
       call append(13,"`ifndef ".toupper(expand("%:r"))."__".toupper(expand("%:e")))
       call append(14,"`define ".toupper(expand("%:r"))."__".toupper(expand("%:e")))
       call append(16,"`endif")
endfunction 
"-----------------------------------------------------------------------------
